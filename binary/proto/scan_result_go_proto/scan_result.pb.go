...
type SecretData_ElasticCloudApiKey struct {
	ElasticCloudApiKey *SecretData_ElasticCloudAPIKey `protobuf:"bytes,20,opt,name=elastic_cloud_api_key,json=elasticCloudApiKey,proto3,oneof"`
}
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\tlocations\x18\x03 \x03(\v2\x11.scalibr.LocationR\tlocations\"\xdc\x17\n" +
	"\n" +
	"SecretData\x124\n" +
	...
	"\x15elastic_cloud_api_key\x18\x14 \x01(\v2&.scalibr.SecretData.ElasticCloudAPIKeyH\x00R\x12elasticCloudApiKey\x1a\xb0\x03\n" +
	"\x06GCPSAK\x12$\n" +
...
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*SecretData_ElasticCloudAPIKey)(nil),               // 85: scalibr.SecretData.ElasticCloudAPIKey
...
var file_proto_scan_result_proto_depIdxs = []int32{
	...
	85, // 88: scalibr.SecretData.elastic_cloud_api_key:type_name -> scalibr.SecretData.ElasticCloudAPIKey
